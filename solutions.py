...
def is_sweltering():
    ...
    temperature = int(input("Please enter the current temperature in Fahrenheit: "))
    if temperature > 90:
        return True
    else:
        return False
...
def is_humid():
    ...
    """
    # write your code for this function below this line.
    humidity = input("Is it currently humid?: ").strip().lower()
    if humidity == "yes":
        return True
    else:
        return False
...
def is_inclement():
    ...
    """
    # write your code for this function below this line.
    forecast = input("What is the weather forecast today? ").strip().lower()
    inclement_conditions = ["rain", "snow", "sleet"]
    if any(condition in forecast for condition in inclement_conditions):
        return True
    else:
        return False
